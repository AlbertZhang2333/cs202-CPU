...
#
# Generated by Vivado on Tue Apr 18 10:54:49 +0800 2023
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/Learning/ComputerOrganization/project/code/project_1/project_1.cache/compile_simlib/activehdl"
  fi
